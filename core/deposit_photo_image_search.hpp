#ifndef DEPOSIT_PHOTO_IMAGE_SEARCH_HPP
#define DEPOSIT_PHOTO_IMAGE_SEARCH_HPP

#include "image_search.hpp"

class deposit_photo_image_search : public image_search
{
    Q_OBJECT
public:
    explicit deposit_photo_image_search(QWebEnginePage &page, QObject *parent = nullptr);
...
#endif // DEPOSIT_PHOTO_IMAGE_SEARCH_HPP
